      ...
      knex('document').insert([
        {
          ...
          json: {
            ...
            text: {
              ...
              data: "If you're seeing this instead of the web site you were expecting, the owner of this web site has just installed Volto. Do not contact the Volto Team or the Volto support channels about this.",
            },
          },
        },
        {
